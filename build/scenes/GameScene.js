...
export class GameScene extends Phaser.Scene {
    ...
    sparkleLayer;
    dragStart = null;
    ballVelocity = new Phaser.Math.Vector2(0, 0);
    ballHome = new Phaser.Math.Vector2(0, 0);
    targetPoint = new Phaser.Math.Vector2(0, 0);
    isBallFlying = false;
    resolving = false;
    currentShiny = false;
    message = "拖住下方精灵球，往后拉再松手。";
    spawnIndex = 0;
    missRecoveryMs = 180;
    escapeRecoveryMs = 240;
    normalCaughtRecoveryMs = 140;
    shinyCaughtRecoveryMs = 320;
    constructor() {
        super("GameScene");
    }
    preload() {
    ...
    registerDomEvents() {
        window.addEventListener(GAME_EVENTS, ((event) => {
    ...
    syncHud() {
        ...
        window.dispatchEvent(new CustomEvent(HUD_EVENTS, { detail: state }));
    }
}

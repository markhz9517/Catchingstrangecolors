...
export function shinyChanceForThrow(throwsSinceLastShiny: number): number {
...
export function rollShiny(throwsSinceLastShiny: number, random: () => number = Math.random): boolean {
